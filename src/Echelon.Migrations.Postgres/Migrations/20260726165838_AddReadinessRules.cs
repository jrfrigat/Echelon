    ...
    public partial class AddReadinessRules : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                "UPDATE \"DeploymentEnvironments\" SET \"IsEnabled\" = false WHERE \"ReadyRule\" <> 'NoGate';");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredSignals = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
