...
using Echelon.Web.Auth;
using Echelon.Web.ExceptionHandling;
using Echelon.Web.HealthChecks;
using Serilog;
...
try
{
    ...
    builder.Services.AddEchelonTelemetry(
        builder.Configuration, "echelon-core", builder.Environment.EnvironmentName);
